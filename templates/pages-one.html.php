  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input type="text" class="form-control" name="title" id="title" value="<?=$this->page->title('raw');?>" placeholder="Tytuł" required>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input type="text" id="description" name="description" value="<?=$this->page->description('raw');?>" placeholder="Opis" class="form-control">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input type="text" id="keywords" name="keywords" value="<?=$this->page->keywords('raw');?>" placeholder="Słowa kluczowe" class="form-control">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input type="text" id="slug" name="slug" value="<?=$this->page->slug();?>" placeholder="URL" class="form-control">
      ...
      <div class="form-group">
        <label for="parent_id" class="col-sm-3 control-label">Strona nadrzędna</label>
        <div class="col-sm-9">
          <select class="form-control select2" id="parent_id" name="parent_id">
            <option value="0">(brak)</option>
            <?php foreach ($this->pages() as $key => $value): ?><option <?=($value['id'] == $this->page->parentID()) ? 'selected="selected" ' : '';?>value="<?=$value['id'];?>"><?=$value['title'];?></option>
            <?php endforeach; ?> 
          </select>
        </div>
      </div>
    ...
    <div class="col-md-4">
      ...
      <?php if ('edit' === $this->templateType): ?> 
      <a class="btn btn-danger btn-lg btn-block" href="<?=$this->page->delUrl();?>">Usuń</a>
      <hr>
      <div class="panel panel-default">
        ...
        <ul class="list-group">
          ...
          <li class="list-group-item">Odnośnik do strony: <b><a target="_blank" href="<?=$this->page->url();?>">zobacz stronę</a></b></li>
        </ul>
      </div>
    <?php endif;?>
    <hr>
    ...
    <div class="panel panel-default">
     <div class="panel-body">
        ...
        <label>
          <input type="checkbox" name="published" class="minimal"<?=$this->page->isPublished() ? ' checked' : '';?>>&nbsp;
        <?php if (!$this->page->isPublished()):?>Zaznacz, by opublikować<?php else:?>Odznacz, by zamienić w szkic<?php endif;?>
        </label>
     </div>
    </div>
